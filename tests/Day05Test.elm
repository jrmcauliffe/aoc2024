module Day05Test exposing (suite)
...
suite =
    describe "Day5 Tests"
        [ describe "Part1"
            [ test "Given Example" <|
                \_ -> part1 (parsePages example1Pages) (parseOrdering example1Ordering) |> equal 143
            , test "Problem" <|
                \_ -> part1 (parsePages problemPages) (parseOrdering problemOrdering) |> equal 5509
            ]
        , describe "Part2"
            [ test "Given Example" <|
                \_ -> part2 (parsePages example1Pages) (parseOrdering example1Ordering) |> equal 123
            , test "Problem" <|
                \_ -> part2 (parsePages problemPages) (parseOrdering problemOrdering) |> equal 4407
            ]
        ]
